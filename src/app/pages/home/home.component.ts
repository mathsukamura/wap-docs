  ...
  features = [
    {
      ...
      description: 'Signal Protocol completo com Double Ratchet, Sender Key para grupos e multi-device fanout.',
    },
    {
    ...
    },
    {
      ...
      description: 'Autenticação automática via QR Code com refresh ou Pairing Code de 8 dígitos.',
    },
  ]
